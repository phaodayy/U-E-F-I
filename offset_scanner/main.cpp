...
int main() {
    ...
    scanDisp("SquadMemberIndex", "48 8D 54 24 48 48 8B 85 ?? ?? ?? ?? 45 33 C0", 8);
    scanDisp("PlayerStatistics", "48 8B BC 24 A0 00 00 00 48 8B 07 48 8B 98 ?? ?? ?? ??", 14);
    scanDisp("DamageDealtOnEnemy", "84 C9 0F 94 C2 48 8D 4D 97 E8 ?? ?? ?? ?? 8B 83 ?? ?? ?? ??", 17);
    scanDisp("SurvivalLevel", "48 8B 8B 28 05 00 00 48 85 C9 0F 85 ?? ?? ?? ?? 48 8B CB E8 ?? ?? ?? ?? 48 8B 8B ?? ?? ?? ??", 27);
