...
int main() {
    ...
    scanDisp("PlayerController", "48 8B ?? 38 48 85 C0 74 25 48 8B 53 30 48 85 D2 74", 3);
    ...
    scanDisp("Pawn", "8B 86 40 04 00 00 89 87 40 04 00 00 8B 86 44 04 00 00 89 87 44 04 00 00 8B 86 48 04 00 00", 24);
    scanDisp("ComponentToWorld", "4C 8D 3C C3 49 3B DF 74 5D 48 8B 33 4C 8B 96 ?? ?? ?? ??", 14);
    ...
    scanDisp("ViewTarget", "48 8D 8D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8B 8D ?? ?? ?? ?? 48 33 CC", 15);
    ...
    scanDisp("InventoryItems", "48 8B 8B 30 06 00 00 BD 01 00 00 00 48 85 C0 0F 85 ?? ?? ?? ?? 48 8B BB", 25);
    ...
    scanDisp("TrajectoryConfig", "48 8B 82 ?? ?? 0C 00 48 89 81 ?? ?? 0C 00 48 8B 82", 3);
    ...
    scanDisp("Health1", "44 8A C8 8B 91 ?? ?? ?? ?? 8B 81 ?? ?? ?? ?? 89 54 24 38", 5);
    scanDisp("Health2", "44 8A C8 8B 91 ?? ?? ?? ?? 8B 81 ?? ?? ?? ?? 89 54 24 38", 11);
    scanDisp("Health3", "89 54 24 38 8B 91 ?? ?? ?? ?? 89 44 24 34 8B 81", 6);
    scanDisp("Health4", "89 44 24 34 8B 81 ?? ?? ?? ?? 89 54 24 30 8B 91", 6);
