...
namespace HyperProcess
{
    bool Initialize();
    bool QueryProcessData(std::uint32_t pid, query_process_data_packet* output, const char* target_name = nullptr);
    LONG_PTR GetWindowStyleStealthily(HWND hwnd, uint32_t pid = 0);
