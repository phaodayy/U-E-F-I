...
void ClacGrenade()
{
    ...
    Sleep(2000); // Do tre chuyen doi aimbot luu dan
    g_isGrenade = false;
    g_isGrenadeEx = false;
}
...
{
    if (!GameData.Config.AimBot.Connected) return;
...
// ... (giữ nguyên các phần trước đó cho đến GetDragForce)
    ...
    static void PressTheLeft()
    {
        ...
        switch (GameData.Config.AimBot.Controller) {
        case 4:
            PubgMemory::MoveMouse(0, 0, 0x0001);
            break;
        case 5:
    ...
    static void PopUpTheLeft()
    {
        ...
        switch (GameData.Config.AimBot.Controller) {
        case 4:
            PubgMemory::MoveMouse(0, 0, 0x0002);
            break;
        case 5:
    ...
    static void Run()
    {
        ...
        while (true)
        {
            ...
            Player* playerPtr = Data::GetPlayersItemPtr(GameData.AimBot.Target);
