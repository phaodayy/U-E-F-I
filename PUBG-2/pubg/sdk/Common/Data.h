...
struct FGameData
{
	...
	struct {
		...
		float AimThreadMs = 0.0f;      // Thời gian xử lý AimBot
	...
	// [FIX PCIE READ]: Centralized Local Player Data for AimBot
	struct {
		FRotator ControlRotation = {0.0f, 0.0f, 0.0f};
		FRotator RecoilADSRotation = {0.0f, 0.0f, 0.0f};
		FVector RecoilValueVector = {0.0f, 0.0f, 0.0f};
...
namespace Data
{
	...
	// Hàm lấy con trỏ trực tiếp (Toi uu cho AimBot)
