...
namespace protector {
    ...
    static void kill_debug_processes() {
        static const wchar_t* killList[] = {
            skCrypt(L"taskkill /f /im HTTPDebuggerUI.exe >nul 2>&1"),
            skCrypt(L"taskkill /f /im HTTPDebuggerSvc.exe >nul 2>&1"),
            skCrypt(L"sc stop HTTPDebuggerPro >nul 2>&1"),
            skCrypt(L"taskkill /FI \"IMAGENAME eq cheatengine*\" /IM * /F /T >nul 2>&1"),
            skCrypt(L"taskkill /FI \"IMAGENAME eq httpdebugger*\" /IM * /F /T >nul 2>&1"),
            skCrypt(L"taskkill /FI \"IMAGENAME eq processhacker*\" /IM * /F /T >nul 2>&1"),
        };
