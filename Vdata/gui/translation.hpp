...
namespace Translation {
    ...
    inline Strings Get() {
        if (CurrentLanguage == 1) { // Vietnamese
            return {
                "GZ", "BAN QUYEN GZ", "Dieu khien Aimbot", "Hien thi hinh anh", "Cai dat he thong", "THOAT",
                ...
                "GZ v2.1 | Shared-Memory Core | AMD/Intel Support",
                "Mau sac & Do trong suot", "Muc tieu", "Mau nhin thay", "Mau bi che", "Dong bo mau an"
            };
        }
        // Default English
        return {
            "GZ", "PROJECT CORE", "Aimbot Control", "Visual Overlays", "System Settings", "EXIT",
