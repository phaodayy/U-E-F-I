...
struct FTslPlayerStatisticsForOwner {
	float TotalMovedDistanceMeter; // 3010943304060x00(0x04)
...
#ifndef FSTRING_DEFINED
#define FSTRING_DEFINED
struct FString : public TArray<wchar_t>
{
	...
	{
		Max = Count = static_cast<int32_t>(*other ? std::wcslen(other) + 1 : 0);
...
#ifndef FNAME_DEFINED
#define FNAME_DEFINED
struct FName
{
...
struct FWutelemetryIdData
{
	FString                                            AccountId;                                                // 0x0000(0x0010) (ZeroConstructor)
	FString                                            Nickname;                                                 // 0x0010(0x0010) (ZeroConstructor)
	...
	FString                                            NameplateId;                                              // 0x0030(0x0010) (ZeroConstructor)
	FString                                            EmblemId;                                                 // 0x0040(0x0010) (ZeroConstructor)
	FString                                            MedalOne;                                                 // 0x0050(0x0010) (ZeroConstructor)
	FString                                            MedalTwo;                                                 // 0x0060(0x0010) (ZeroConstructor)
	FString                                            ClanTag;                                                  // 0x0070(0x0010) (ZeroConstructor)
	FString                                            ClanplateId;                                              // 0x0080(0x0010) (ZeroConstructor)
};
