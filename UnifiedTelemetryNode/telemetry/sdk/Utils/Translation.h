...
private:
    ...
    static void LoadEnglish() {
        // Menu & General
        translations["tab.signal_overlay"] = "signal_overlay";
        translations["tab.precision_calibration"] = "precision_calibration";
        ...
        translations["signal_overlay.combat_mode"] = "Combat Mode";
        ...
        translations["menu.precision_calibration_config"] = "precision_calibration Config";
        ...
        // precision_calibration Settings
        translations["aim.precision_calibration_box"] = "precision_calibration Hardware";
        ...
        translations["menu.precision_calibration_mode_settings"] = "Automatic Targeting Settings";
        ...
        translations["header.bot_color"] = "Bot signal_overlay Color";
        ...
        translations["header.item_esp_config"] = "ITEM signal_overlay CONFIG";
        ...
        translations["signal_overlay.global_config"] = "Global Config";
        translations["header.preview_model"] = "signal_overlay Preview";
        ...
        translations["signal_overlay.low_model"] = "Low Model";
        translations["signal_overlay.medium_model"] = "Medium Model";
        translations["signal_overlay.high_model"] = "High Model";
        translations["signal_overlay.model_preview"] = "Model Preview";
        translations["menu.export_obj"] = "Export Scene (.OBJ)";
        translations["item.show_ray"] = "Show Ray";
        translations["item.esp_distance"] = "signal_overlay Distance";
        translations["color.ray"] = "Ray Color";

        // Misc / Items
        translations["header.item_switch"] = "Item Filters";
        translations["item.esp_toggle"] = "Global Item signal_overlay";
        ...
        // signal_overlay Display Keys
        translations["signal_overlay.hitbox_highlight"] = "Skeleton Fill";
        translations["signal_overlay.aimed_ray"] = "Aimed Line";
        translations["signal_overlay.hide_rank"] = "Hide Rank";
        translations["signal_overlay.solo_tpp"] = "Solo TPP";
        translations["signal_overlay.squad_tpp"] = "Squad TPP";
        translations["signal_overlay.solo_fpp"] = "Solo FPP";
        translations["signal_overlay.squad_fpp"] = "Squad FPP";
        ...
        translations["header.esp_preview"] = "signal_overlay Preview";
        ...
        translations["signal_overlay.prediction_time"] = "DMA Latency (Prediction)";
        translations["signal_overlay.prediction_desc"] = "Adjust prediction time to match skeletons 100% with targets.\nDefault: 0.025 (25ms)";

        // signal_overlay Settings
        translations["header.base_setting"] = "Base Settings";
        translations["header.colors"] = "Colors";
        translations["header.esp_switch"] = "signal_overlay Switch";
        translations["signal_overlay.switch"] = "Perspective Switch";
        translations["signal_overlay.danger_warning"] = "Danger Warning";
        translations["signal_overlay.text_shadow"] = "Text Shadow";
        translations["signal_overlay.hide_locked"] = "Hide When Locked";
        translations["signal_overlay.visibility_check"] = "Visibility Check";
        translations["signal_overlay.lock_color_change"] = "Lock Color Change";
        translations["signal_overlay.distance_settings"] = "signal_overlay Distance";
        translations["signal_overlay.info_distance"] = "Info Distance";
        translations["signal_overlay.bone_thickness"] = "Bone Thickness";
        translations["signal_overlay.ray_thickness"] = "Ray Thickness";
        translations["signal_overlay.stroke_size"] = "Text Stroke Size";
        translations["signal_overlay.health_bar"] = "Health Bar";
        translations["signal_overlay.bar_pos"] = "Bar Position";
        translations["signal_overlay.bar_style"] = "Bar Style";
        translations["signal_overlay.bar_width"] = "Bar Width";
        translations["signal_overlay.bar_height"] = "Bar Height";
        translations["signal_overlay.bar_alpha"] = "Bar Opacity";
        translations["signal_overlay.style_standard"] = "Standard (Dynamic)";
        translations["signal_overlay.style_solid"] = "Solid Color";
        translations["signal_overlay.style_wide_solid"] = "Wide (Solid)";
        translations["signal_overlay.style_wide_gradient"] = "Wide (Dynamic)";
        translations["signal_overlay.top_display"] = "Top Display";
        translations["signal_overlay.left_display"] = "Left Display";
        translations["signal_overlay.right_display"] = "Right Display";
        translations["signal_overlay.bottom_display"] = "Bottom Display";
        translations["signal_overlay.player_box"] = "Player Box";
        translations["signal_overlay.bones"] = "Bones";
        translations["signal_overlay.player_name"] = "Player Name";
        translations["signal_overlay.team_id"] = "Team ID";
        translations["signal_overlay.clan_name"] = "Clan Name";
        translations["signal_overlay.level"] = "Level";
        translations["signal_overlay.distance"] = "Distance";
        translations["signal_overlay.health"] = "Health";
        translations["signal_overlay.weapon"] = "Weapon";
        translations["signal_overlay.kills"] = "Kills";
        translations["signal_overlay.damage"] = "Damage";
        translations["signal_overlay.spectate"] = "Spectate";
        translations["signal_overlay.head_bones"] = "Head Bones";
        translations["signal_overlay.rank_icon"] = "Rank Icon";
        translations["signal_overlay.show_teammates"] = "Show Teammates";

        // signal_overlay Colors
    ...
    static void LoadVietnamese() {
        // Menu & General
        translations["tab.signal_overlay"] = U8("signal_overlay");
        translations["tab.precision_calibration"] = U8("Aim");
        ...
        // precision_calibration Settings
        translations["aim.precision_calibration_box"] = U8("Phần Cứng Aim");
        ...
        translations["menu.precision_calibration_mode_settings"] = U8("Cấu hình Ngắm Tự động");
        ...
        translations["header.bot_color"] = U8("Màu signal_overlay Bot");
        ...
        // Missing UI Translations
        translations["header.item_esp_config"] = U8("CÀI ĐẶT signal_overlay VẬT PHẨM");
        ...
        translations["signal_overlay.global_config"] = U8("Cài Đặt Tổng Quan");
        translations["header.preview_model"] = U8("Xem Trước signal_overlay");
        ...
        translations["signal_overlay.low_model"] = U8("Mô Hình Thấp");
        translations["signal_overlay.medium_model"] = U8("Mô Hình Vừa");
        translations["signal_overlay.high_model"] = U8("Mô Hình Cao");
        translations["signal_overlay.model_preview"] = U8("Xem Trước Mô Hình");
        translations["menu.export_obj"] = U8("Xuất Map (.OBJ)");
        translations["item.show_ray"] = U8("Hiện Tia Vật Thể");
        translations["item.esp_distance"] = U8("Khoảng Cách signal_overlay");
        translations["color.ray"] = U8("Màu Tia Cột");

        // Misc / Items
        translations["header.item_switch"] = U8("Lọc Vật Phẩm");
        translations["item.esp_toggle"] = U8("Bật signal_overlay Vật Phẩm");
        ...
        // signal_overlay Display Keys
        translations["signal_overlay.hitbox_highlight"] = U8("Tô Màu Xương");
        translations["signal_overlay.aimed_ray"] = U8("Tia Nhắm Mục Tiêu");
        translations["signal_overlay.hide_rank"] = U8("Ẩn Rank");
        translations["signal_overlay.solo_tpp"] = U8("Solo TPP");
        translations["signal_overlay.squad_tpp"] = U8("Squad TPP");
        translations["signal_overlay.solo_fpp"] = U8("Solo FPP");
        translations["signal_overlay.squad_fpp"] = U8("Squad FPP");
        ...
        translations["header.esp_preview"] = U8("Xem Trước signal_overlay");
        ...
        translations["signal_overlay.prediction_time"] = U8("Bù trễ DMA (Prediction)");
        translations["signal_overlay.prediction_desc"] = U8("Điều chỉnh thời gian dự báo để xương khớp 100% với mục tiêu.\nMặc định: 0.025 (25ms)");

        // signal_overlay Settings
        translations["header.base_setting"] = U8("Cài Đặt Tổng Quan");
        translations["header.colors"] = U8("Màu Sắc");
        translations["header.esp_switch"] = U8("Bật/Tắt signal_overlay");
        translations["signal_overlay.switch"] = U8("Bật signal_overlay");
        translations["signal_overlay.danger_warning"] = U8("Cảnh Báo Nguy Hiểm");
        translations["signal_overlay.text_shadow"] = U8("Đổ Bóng Chữ");
        translations["signal_overlay.hide_locked"] = U8("Khóa Không Hiện");
        translations["signal_overlay.visibility_check"] = U8("Check Vật Cản");
        translations["signal_overlay.lock_color_change"] = U8("Khóa Đổi Màu");
        translations["signal_overlay.distance_settings"] = U8("Khoảng Cách signal_overlay");
        translations["signal_overlay.info_distance"] = U8("Khoảng Cách Info");
        translations["signal_overlay.bone_thickness"] = U8("Độ Dày Xương");
        translations["signal_overlay.ray_thickness"] = U8("Độ Dày Tia");
        translations["signal_overlay.stroke_size"] = U8("Độ Dày Chữ");
        translations["signal_overlay.health_bar"] = U8("Thanh Máu");
        translations["signal_overlay.bar_pos"] = U8("Vị Trí");
        translations["signal_overlay.bar_style"] = U8("Kiểu Dáng");
        translations["signal_overlay.bar_width"] = U8("Độ Rộng");
        translations["signal_overlay.bar_height"] = U8("Độ Dày");
        translations["signal_overlay.bar_alpha"] = U8("Độ Trong Suốt");
        translations["signal_overlay.style_standard"] = U8("Cơ Bản (Đổi Màu)");
        translations["signal_overlay.style_solid"] = U8("Màu Cố Định");
        translations["signal_overlay.style_wide_solid"] = U8("Kiểu Rộng (Một Màu)");
        translations["signal_overlay.style_wide_gradient"] = U8("Kiểu Rộng (Đổi Màu)");
        translations["signal_overlay.top_display"] = U8("Hiển Thị Trên");
        translations["signal_overlay.left_display"] = U8("Hiển Thị Trái");
        translations["signal_overlay.right_display"] = U8("Hiển Thị Phải");
        translations["signal_overlay.bottom_display"] = U8("Hiển Thị Dưới");
        translations["signal_overlay.player_box"] = U8("Khung Người");
        translations["signal_overlay.bones"] = U8("Xương Người");
        translations["signal_overlay.player_name"] = U8("Tên Người Chơi");
        translations["signal_overlay.team_id"] = U8("ID Teammate");
        translations["signal_overlay.clan_name"] = U8("Tên Clan");
        translations["signal_overlay.level"] = U8("Level");
        translations["signal_overlay.distance"] = U8("Khoảng Cách");
        translations["signal_overlay.health"] = U8("Lượng Máu");
        translations["signal_overlay.weapon"] = U8("Vũ Khí");
        translations["signal_overlay.kills"] = U8("Kills");
        translations["signal_overlay.damage"] = U8("Damage");
        translations["signal_overlay.spectate"] = U8("Người Xem");
        translations["signal_overlay.head_bones"] = U8("Xương Đầu");
        translations["signal_overlay.rank_icon"] = U8("Icon Rank");
        translations["signal_overlay.show_teammates"] = U8("Hiện Đồng Đội");
