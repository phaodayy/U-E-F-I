...
namespace protector {
    ...
    //   - PEB->BeingDebugged direct read (evasion_calibration API hooks)
    ...
    static void patch_anti_attach() {
        ...
        // BattlEye/EasyAntiintegrity_monitor will detect modified bytes in system DLLs.
    ...
    static bool scan_blacklisted_processes() {
        return scan_blacklisted_processes_impl(
            ...
            skCrypt(L"integrity_monitorengine-x86_64.exe"), skCrypt(L"integrity_monitor Engine.exe"),
            skCrypt(L"KsDumperClient.exe"), skCrypt(L"KsDumper.exe"),
            skCrypt(L"Processdiagnostic_nodeer.exe"), skCrypt(L"procmon.exe"), skCrypt(L"procexp.exe"), skCrypt(L"procexp64.exe"),
    ...
    static bool scan_window_titles() {
        return scan_window_titles_impl(
            ...
            skCrypt(L"Memory Viewer"), skCrypt(L"integrity_monitor Engine"),
            skCrypt(L"integrity_monitor Engine 7.0"), skCrypt(L"integrity_monitor Engine 7.1"), skCrypt(L"integrity_monitor Engine 7.2"),
            skCrypt(L"integrity_monitor Engine 7.3"), skCrypt(L"integrity_monitor Engine 7.4"), skCrypt(L"integrity_monitor Engine 7.5"),
            ...
            skCrypt(L"HxD"),
            skCrypt(L"Snowman"),
            skCrypt(L"Process diagnostic_nodeer"),
    ...
    // =========================================================================
    // Ghi chú V4: Việc sử dụng OpenProcess(PROCESS_TERMINATE) nhắm vào Anti-integrity_monitor
    ...
    // hoặc Thoát chính chương trình integrity_monitor (ẩn mình), TUYỆT ĐỐI không được can thiệp 
    ...
    static void check_debug_processes() {
        const wchar_t* killList[] = {
            ...
            skCrypt(L"integrity_monitorengine-x86_64.exe"),
            skCrypt(L"integrity_monitor Engine.exe"),
            skCrypt(L"Processdiagnostic_nodeer.exe"),
            skCrypt(L"HTTP Debugger Windows Service (32 bit).exe")
        };
    ...
    static void kill_game() {
        ...
        // Giết tiến trình BE/telemetry bằng Usermode API là hành vi kích hoạt lệnh Ban lập tức.
