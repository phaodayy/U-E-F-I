...
inline void FillVietnamese(Strings& s) {
            ...
            s.NamePos = (const char*)u8"Vị trí tên";
            s.DistancePos = (const char*)u8"Vị trí khoảng cách";
            s.WeaponPos = (const char*)u8"Vị trí vũ khí";
            s.RankPos = (const char*)u8"Vị trí bậc";
            s.SpectatedPos = (const char*)u8"Vị trí theo dõi";
        ...
        s.TabAdmin = (const char*)u8"[?] Admin";
            ...
            s.PlayerList = (const char*)u8"Danh sách Player";
            s.Spectators = (const char*)u8"Người xem";
            ...
            s.Damage = (const char*)u8"Sát thương";
            s.Speed = (const char*)u8"Tốc độ";
            s.AimWarn = (const char*)u8"Cảnh báo ngắm";
            s.CloseWarn = (const char*)u8"Cảnh báo gần";
            s.ViewRay = (const char*)u8"Tia nhìn";
            s.FireTrace = (const char*)u8"Tia bắn";
            s.RayWidth = (const char*)u8"Độ dày tia";
            s.BigMap = (const char*)u8"Map lớn";
            s.MiniMap = (const char*)u8"Mini map";
            s.EnableMiniMap = (const char*)u8"Bật mini map";
            s.EnableBigMap = (const char*)u8"Bật map lớn";
            s.NameRadar = (const char*)u8"Tên trên map";
            s.DirectionRadar = (const char*)u8"Hướng trên map";
            s.NameBackground = (const char*)u8"Nền tên";
            s.VehicleRadar = (const char*)u8"Xe trên map";
            s.AirdropRadar = (const char*)u8"Thùng tiếp tế";
            s.DeadBoxRadar = (const char*)u8"Hòm xác";
            s.MapLegend = (const char*)u8"Chú giải map";
            s.Enemy = (const char*)u8"Địch";
            s.Vehicle = (const char*)u8"Xe";
            s.State = (const char*)u8"Trạng thái";
            s.HelmetShort = (const char*)u8"Mũ";
            s.VestShort = (const char*)u8"Giáp";
            s.BackpackShort = (const char*)u8"Balo";
